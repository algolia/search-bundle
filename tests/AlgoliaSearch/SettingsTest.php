...
class SettingsTest extends BaseTest
{
    ...
    public function testBackup()
    {
        ...
        $index = $this->client->initIndex('sf4_bundle_testing_posts');
        ...
        $this->assertTrue(file_exists($this->settingsDir.'/sf4_bundle_testing_posts-settings.json'));

        $savedSettings = json_decode(file_get_contents(
            $this->settingsDir.'/sf4_bundle_testing_posts-settings.json'
        ), true);
